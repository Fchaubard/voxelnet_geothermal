...
- r=5 model is recommended: best accuracy on both pressure and temperature
...
- `best_r5_step53000.pt` - **Recommended**: Larger model (11x11x11 kernel), best accuracy
...
voxelnet_geothermal/
  checkpoints/
    best_r5_step53000.pt     # Recommended: best accuracy
